...
@Entity
@Table(name = "company")
public class Company extends Receiver
{
    ...
    public Company(String name, String urlWebSite, String words, LocalDate created, String numberPhone1,
            String numberPhone2, String numberPhone3, String email1, String email2, String email3, String seat)
    {
        this.name = name;
